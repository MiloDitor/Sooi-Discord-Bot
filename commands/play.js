...
module.exports = {
    name: 'play',
    aliases: ['skip', 'leave', 'pause', 'unpause'],
    description: 'big boy bot',
    async execute(client, message, args, cmd, Discord) { 

        const voice_channel = message.member.voice.channel;
        if (!voice_channel) return message.channel.send('You need to be in a channel use this command!');
        ...
        if (cmd === 'play'){
            if (!args.length) return message.channel.send('You need to send the song name or link!');
            let song = {};
